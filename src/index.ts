...
export async function request(method: string, url: string, config?: PolvoConfig): Promise<PolvoResponse> {
    return defaultSession.request(method, url, config);
}

export async function get(url: string, config?: PolvoConfig): Promise<PolvoResponse> {
    return defaultSession.get(url, config);
}

export async function post(url: string, data?: any, config?: PolvoConfig): Promise<PolvoResponse> {
    return defaultSession.post(url, data, config);
}

export async function put(url: string, data?: any, config?: PolvoConfig): Promise<PolvoResponse> {
    return defaultSession.put(url, data, config);
}

export async function patch(url: string, data?: any, config?: PolvoConfig): Promise<PolvoResponse> {
    return defaultSession.patch(url, data, config);
}

export async function del(url: string, config?: PolvoConfig): Promise<PolvoResponse> {
    return defaultSession.delete(url, config);
}

export async function head(url: string, config?: PolvoConfig): Promise<PolvoResponse> {
    return defaultSession.head(url, config);
}

export async function options(url: string, config?: PolvoConfig): Promise<PolvoResponse> {
...
async function polvo(configOrUrl: string | PolvoFunctionConfig, config?: PolvoConfig): Promise<PolvoResponse> {
